...
extern size_t my_fwrite(const void *ptr, size_t size, size_t nmemb, FILE *stream);
...
extern int64_t copy_bytes_between_two_files(const size_t bytes, FILE *in, FILE *out);
extern int64_t copy_bytes_with_pread(const size_t bytes, int in, int out, off_t offset);    
